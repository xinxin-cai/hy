// ===== 生长周期数据 =====
var growthData = [
  { name:'育苗附着期',img:'baoyu1.jpeg',labels:['第1天','第3天','第5天','第7天','第9天','第11天','第13天','第14天','第15天','第15天'],params:{ temp:'20–24°C',period:'1–15天',desc:'鲍鱼幼虫附着在采苗板上，分泌足丝固定，开始底栖生活',care:'保持水质稳定，提供充足的附着基，控制光照强度' },values:[2,5,12,20,28,35,42,48,55,62] },
  ...
  { name:'幼鲍培育期',img:'baoyu3.jpeg',labels:['第2月','第2.5月','第3月','第3.5月','第4月','第4.5月','第5月','第5.5月','第6月','第6月'],params:{ temp:'20–26°C',period:'2–6月',desc:'幼鲍转入海上吊笼培育，壳长继续增长，摄食转向大型海藻',care:'定期清洗吊笼，防控敌害生物，关注附着基更换' },values:[260,285,310,340,370,395,415,440,465,490] },
  { name:'海上养成期',img:'baoyu4.jpeg',labels:['第6月','第8月','第10月','第12月','第14月','第15月','第16月','第17月','第18月','第18月'],params:{ temp:'19–25°C',period:'6–18月',desc:'进入海上渔排规模化养成，鲍鱼快速增重，壳长达5-8cm',care:'监控海域水温盐度波动，合理调控投喂频率与饵料种类' },values:[490,530,580,635,690,745,800,850,895,940] },
  { name:'成品育肥期',img:'baoyu5.jpeg',labels:['第18月','第18.5月','第19月','第19.5月','第20月','第20.5月','第21月','第21.5月','第22月','第22月'],params:{ temp:'18–24°C',period:'18–22月',desc:'鲍鱼闭壳肌增厚，肉质饱满度最佳，可达商品规格标准',care:'强化营养投喂，控制养殖密度，做好出池前品质评估' },values:[940,970,995,1015,1030,1040,1045,1048,1050,1050] },
  { name:'采收储运期',img:'baoyu6.jpeg',labels:['T+1天','T+3天','T+5天','T+7天','T+10天','T+12天','T+14天','T+16天','T+18天','T+20天'],params:{ temp:'2–6°C(冷链)',period:'22月+',desc:'按规格分拣包装，冷链运输直达市场，全程可追溯管控',care:'严格控制冷链温区，缩短周转时间，保障成品鲜活品质' },values:[1050,1050,1050,1050,1050,1050,1050,1050,1050,1050] }
];
